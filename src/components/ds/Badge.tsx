...
type Variant = "default" | "ts" | "go" | "zig" | "rust" | "primary" | "success" | "error";
...
const filledClass: Record<Variant, string> = {
  ...
  zig: "bg-accent-zig/15 text-accent-zig border-accent-zig/40",
  rust: "bg-accent-rust/15 text-accent-rust border-accent-rust/40",
